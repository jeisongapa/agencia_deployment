...
CREATE TABLE `testimoniales` (
  ...
  `mensaje` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  UNIQUE KEY `id` (`id`)
...
INSERT INTO `testimoniales` VALUES (1,'JEISON ANDRES','jeison@gmail.com','AAA'),(2,'estefania','jeison@gmail.com','AAA'),(3,'estefania','jeison@gmail.com','AAA'),(4,'jaja','jeison@gmail.com','AAA'),(5,'Uno nuevo','jeison@gmail.com','buenas vacaciones');
...
-- Dump completed on 2021-07-11 21:31:00
